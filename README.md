...
> Estado: **v0.0.1 — protótipo funcional de análise pós-sessão**
...
O projeto segue Semantic Versioning. A política e o checklist de release estão em
[docs/VERSIONING.md](docs/VERSIONING.md).

## Privacidade e limites

O processamento é local; nenhum upload externo é necessário. A v0.0.1 é uma ferramenta
pós-sessão: ainda não lê a memória do Assetto Corsa ao vivo, não altera setups e não usa
FastF1 ou IA.
